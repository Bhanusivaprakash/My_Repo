...
## ⚙️ Project 3: DC-DC Buck Converter with current sensing (12V → 3.3V)

A DC-DC Buck Converter with integrated current sensing for monitoring and control applications.
